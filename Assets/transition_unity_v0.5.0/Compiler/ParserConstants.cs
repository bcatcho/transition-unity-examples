namespace Transition.Compiler
{
   ...
   public static class ParserConstants
   {
      ...
      /// <summary>
      /// This keyword is used as the name for a default parameter in the abstract syntax tree.
      ...
      /// requires a name for each parameter. In the second example this value is used.
      /// </summary>
      public const string DefaultParameterName = "$default";
   }
}
